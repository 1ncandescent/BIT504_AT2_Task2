...
public class GameMain extends JPanel implements MouseListener{
	...
	// number of ROWS by COLS cell constants & window title
	...
	public GameMain() {   
		...
		/*
		 * Added in a mouse listener that listens for events within the 
		 * main game window
		 */
		...
		/*
		 * variable for defining and creating a new game board at
		 * at the start of a new game
		 */
		board = new Board();
		
		// method to set up the board for a new game is invoked
		initGame();
	}
	...
	public void paintComponent(Graphics g) {
	  ...
	  /** Initialise the game-board contents and the current status of GameState and Player) */
		...
		/* 
		 * After each turn check to see if the current player hasWon 
		 * by putting their symbol in that position, If they have the
		 * GameState is set to won for that player. If no winner then 
		 * isDraw is called to see if deadlock, if not GameState stays as PLAYING
		 */
